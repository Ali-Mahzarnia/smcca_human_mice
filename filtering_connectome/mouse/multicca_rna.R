...
riskfactors_new=riskfactors%>%select(Genotype ,Weight, Sex, Age_Months)
...
riskfactors =riskfactors%>%select(Genotype ,Weight, Sex, Age_Months)
...
desired_sparsity_z=.9995 #.9995 and 0.9905343
...
write.xlsx2(RNA_result_ordered, "RNA_result_ordered2.xlsx" )
...
pathnames='/Users/ali/Desktop/Mar23/Hae_new_connectome/apoe234/mouse_anatomy.csv'
