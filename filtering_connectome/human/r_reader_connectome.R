...
path_master='/Users/ali/Desktop/april23/smcca_human/AD_DECODE_data.csv'
data=read.csv(path_master )
data = as.data.frame(data)
datatemp=data%>%dplyr::select(Subject,MRI_Exam,genotype,Weight, sex, risk_for_ad, age)#subselect
...
####plains
path_connec="/Users/ali/Desktop/april23/smcca_human/connectome/"
...
#
RNA=read.delim('/Users/ali/Desktop/april23/smcca_human/humanwithsymbol.txt',sep="\t", header = T)
RNA=t(RNA)
